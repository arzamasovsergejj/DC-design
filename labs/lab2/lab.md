...
```
spine-2(config-if-Lo1)#show running-config
! Command: show running-config
...
```
```
spine-2(config-if-Lo1)#show ip route ospf detail
...
Codes: C - connected, S - static, K - kernel,
 ...
 O        10.4.0.8/29 [110/20] via 10.2.2.1, Ethernet1
 O        10.4.0.16/29 [110/20] via 10.2.2.3, Ethernet2
 O        10.4.0.24/29 [110/20] via 10.2.2.5, Ethernet3
 O        10.4.0.32/29 [110/20] via 10.2.2.5, Ethernet3
```
